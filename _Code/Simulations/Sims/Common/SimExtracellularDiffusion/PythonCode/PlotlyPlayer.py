...
class PlotlyPlayer:
    ...
    # Used only when isUseOpacitiesOrColours is True
    _markerColour = '0, 0, 255'
    
    # Used only when isUseOpacitiesOrColours is False
    _opacity = 0.25
    _palette = 'viridis'
    ...
    def __init__(self, x, y, z, rangeVar, t, varNameWithIndexAndUnits, isUseOpacitiesOrColours, rangeVar_min, rangeVar_max):
            ...
            'buttons': [
                {
                    'label': 'Start',
                    'method': 'animate',
                    'args': [None, {'frame': {'duration': 0, 'redraw': True}, 'fromcurrent': True, 'transition': {'duration': 0, 'easing': 'quadratic-in-out'}}]
                },
                {
                    'label': 'Stop',
                    'method': 'animate',
